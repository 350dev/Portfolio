            ...
            <div className="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul className="navbar-nav brand">
                    ...
                    <li className="brand-txt">
                        <h5 className="brand-title">Martin Hernandez</h5>
                        <div className="brand-subtitle">Full Stack | Front-end Developer</div>
                    </li>
                </ul>
        ...
        <div id="about" className="row about-section">
            ...
            <div className="col-lg-4 about-card">
                ...
                <ul className="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 04/11/1998</li>
                    <li><span>Email</span> : martin111dev@outlook.com</li>
                ...
                <div className="col-md-6 col-lg-4">
                    <div className="card">
                       <div className="card-header">
                        ...
                        <div className="card-body">
                            <h6 className="title text-danger">Jun 2012 - Apr 2016</h6>
                            <p>Technical University of Braunschweig</p>
                            <p className="subtitle">Bachelor's Degree in Computer Science</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="contact-info-card">
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-10 ">
                                <h6 className="d-inline">Phone : <span className="text-muted">+ (49) 5341 8139 706</span></h6>
                            </div>
                        </div>
                        <div className="row mb-2">
                            <div className="col-1 pt-1 mr-1">
                            ...
                            <div className="col-10">
                                <h6 className="d-inline">Address : <span className="text-muted">25 Braunschweig, Lower Saxony Germany.</span></h6>
                            </div>
                        </div>
                        <div className="row mb-2">
                            <div className="col-1 pt-1 mr-1">
